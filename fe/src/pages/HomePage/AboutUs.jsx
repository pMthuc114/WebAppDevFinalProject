...
const AboutUs = ({
  ...
  description2 = "Với sự kết hợp hoàn hảo giữa công nghệ và sự tinh tế, mỗi đôi giày tại Shoes Store đều giúp bạn thoải mái suốt ngày dài và tự tin tỏa sáng.",
  chooseUsTitle = "TẠI SAO CHỌN Shoes STORE",
